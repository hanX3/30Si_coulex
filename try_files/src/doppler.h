...
// Fri Dec 17 23:24:13 2021 by ROOT version 6.12/06
// from TTree tr1/timewindow_origin
// found on file: run00804_ana.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           n_Si_ring;
   Int_t           Si_ring_mod[24];   //[n_Si_ring]
   Int_t           Si_ring_ch[24];   //[n_Si_ring]
   Double_t        Si_ring_adc[24];   //[n_Si_ring]
   Double_t        Si_ring_ts[24];   //[n_Si_ring]
   Int_t           n_Si_sector;
   Int_t           Si_sector_mod[32];   //[n_Si_sector]
   Int_t           Si_sector_ch[32];   //[n_Si_sector]
   Double_t        Si_sector_adc[32];   //[n_Si_sector]
   Double_t        Si_sector_ts[32];   //[n_Si_sector]
   Int_t           n_Ge;
   Int_t           Ge_mod[36];   //[n_Ge]
   Int_t           Ge_ch[36];   //[n_Ge]
   Double_t        Ge_adc[36];   //[n_Ge]
   Double_t        Ge_energy[36];   //[n_Ge]
   Double_t        Ge_ts[36];   //[n_Ge]
...
void doppler::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Ge_adc", Ge_adc, &b_Ge_adc);
