...
if [ $# -ne 3 ];then
  echo "need 3 parameter."
  echo "such as: ./batch_analysis.sh 13 2 degree 5 degree"
  exit 1
fi
...
#sed -i "s/aaa/${3}/g" set.h
#sed -i "s/11.25\*(double)i/11.25\*(double)(i+${2})/g" angle_info.cpp
